...
//
    ...
    public static ArrayList<Earthquake> extractEarthquakes(String jsonResponse){
        ...
        try {
            ...
            JSONObject baseJsonResponse = new JSONObject(String.valueOf(jsonResponse));
            ...
            for (int i = 0; i< earthquakeArray.length(); i++){
                ...
                String magnitude = decimalFormat.format(properties.getDouble("mag"));
                String location = properties.getString("place");
                String time = dateFormat.format(new Date(Long.parseLong(properties.getString("time"))));
